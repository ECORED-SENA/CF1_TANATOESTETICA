  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Tanatoestética: historia

    .row.align-items-center.px-5.mb-5
      .col-lg-5(data-aos="fade-right")
        figure
          img(src='@/assets/curso/tema2/f1.svg' alt='Tanatopraxia y tanatoestética').my-4
      .col-lg-7
    ...
    .col-lg-11.mx-auto
      PasosA.color-primario.mb-5(tipo="n")
        .row.align-items-center.justify-content-center
          .col-lg-2(data-aos="flip-right")
            figure.mw115px.mx-auto
              img(src='@/assets/curso/tema2/f2.svg' alt='Icono faraón')
          .col-lg-10
        ...
        .row.align-items-center.justify-content-center
          ...
          .col-lg-2(data-aos="flip-right")
            figure.mw115px.mx-auto
              img(src='@/assets/curso/tema2/f3.svg' alt='Icono faraón')
        .row.align-items-center.justify-content-center
          .col-lg-2(data-aos="flip-right")
            figure.mw115px.mx-auto
              img(src='@/assets/curso/tema2/f4.svg' alt='Icono faraón')
          .col-lg-10
