  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center
      ...
      .col-lg-5.mb-4.mb-lg-0.order-1.order-lg-2(data-aos="zoom-in")
        img(src="@/assets/curso/tema3/img_1_01.svg", alt="alt").img--500.m-auto

    .row.justify-content-center.align-items-center.gx-0.mb-5
      .col-lg-5.mb-4.mb-lg-0(data-aos="zoom-in")
        img(src="@/assets/curso/tema3/img_1_02.png", alt="alt").img--500.m-auto
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5(data-aos="flip-left")
        .crd.crd--gray.crd--round.left--LineRed
          figure.mb-4
            img(src="@/assets/curso/tema3/img_1_03.svg", alt="alt", style="width:120px;").m-auto
      ...
      .col-lg-5(data-aos="flip-left")
        .crd.crd--gray.crd--round.Rigth--LineGreen
          figure.mb-4
            img(src="@/assets/curso/tema3/img_1_04.svg", alt="alt", style="width:120px;").m-auto
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-xl-5.mb-4.mb-lg-0(data-aos="zoom-in")
        img(src="@/assets/curso/tema3/img_1_05.svg", alt="alt").img--500.m-auto
      .col-xl-7
      ...
      SlyderA(tipo="b")
        .row.mt-4
          ...
          .col-lg-6(data-aos="zoom-in-up")
            figure
              img(src='@/assets/curso/tema3/img_1_06.png', alt='Texto que describa la imagen')
        ...
        .row.mt-4
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema3/img_1_07.png', alt='Texto que describa la imagen')
        ...
        .row.mt-4
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema3/img_1_08.png', alt='Texto que describa la imagen')
        ...
        .row.mt-4
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema3/img_1_09.png', alt='Texto que describa la imagen')
        ...
        .row.mt-4
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema3/img_1_10.png', alt='Texto que describa la imagen')
        ...
        .row.mt-4
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema3/img_1_11.png', alt='Texto que describa la imagen')
    ...
    .bloque-texto-a.bg--greenGray.p-4.p-md-5.mb-5
      .row.m-0.align-items-center.justify-content-between
        ...
        .col-lg-4.mb-4.mb-lg-0.order-1.order-lg-2(data-aos="zoom-in")
          img(src="@/assets/curso/tema3/img_1_12.svg", alt="alt").m-auto.img--500

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5.mb-4.mb-lg-0(data-aos="zoom-in")
        img(src="@/assets/curso/tema3/img_1_13.png", alt="alt").m-auto.img--500
      .col-lg-7
    ...
    SlyderF.mb-5.py-4(columnas="col-lg-6 col-xl-4")
      ...
      .crd.crd--bottomLine.m-4
        img(src="@/assets/curso/tema3/img_1_14.svg", alt="alt", style="width:90px;").m-auto.mb-4
      ...
      .crd.crd--bottomLine.crd--bottomLine_red.m-4
        img(src="@/assets/curso/tema3/img_1_15.svg", alt="alt", style="width:90px;").m-auto.mb-4
        p.text-center Cubrir los genitales del cadáver con una tela.


      .crd.crd--bottomLine.m-4
        img(src="@/assets/curso/tema3/img_1_16.svg", alt="alt", style="width:90px;").m-auto.mb-4
        p.text-center No hacer fotografías y videos sin la autorización previa de la familia.


      .crd.crd--bottomLine.crd--bottomLine_red.m-4
        img(src="@/assets/curso/tema3/img_1_17.svg", alt="alt", style="width:90px;").m-auto.mb-4
        p.text-center No divulgar las condiciones de la muerte o patologías existentes en el cuerpo sin vida.


      .crd.crd--bottomLine.m-4
        img(src="@/assets/curso/tema3/img_1_18.svg", alt="alt", style="width:90px;").m-auto.mb-4
    ...
    .bloque-texto-a.bg--greenGray.p-4.p-md-5.mb-5
      .row.m-0.align-items-center.justify-content-between
        ...
        .col-lg-4.mb-4.mb-lg-0.order-1.order-lg-2(data-aos="zoom-in")
          img(src="@/assets/curso/tema3/img_1_19.svg", alt="alt").m-auto.img--500
